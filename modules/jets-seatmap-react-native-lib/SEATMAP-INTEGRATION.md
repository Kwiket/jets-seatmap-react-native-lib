...
Seat map prop thats can be provided if you want to override JetsSeat with you custom seat component, the value should have type JSX.Element and ISeatData as a paramter

```typescript
const SeatOverride = ({seat}: {seat: ISeatData}) => {
  return (
    <View
      children={
        <>
