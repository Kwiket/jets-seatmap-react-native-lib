              ...
              style={[
                deckFloorStyle,
                {
                  ...
                  borderWidth: Math.max(
                    (params.innerWidth - item.width) * 0.5 - fuselageStrokeWidth,
                    fuselageStrokeWidth,
                  ),
                  borderTopWidth: 0,
                  borderBottomWidth: 0,
                ...
                <View
                  children={
                    <Nose
                      ...
                      wingsWidth={
                        params?.visibleWings != undefined && params?.visibleWings ? colorTheme?.wingsWidth : 0
                      }
                      storkeWidth={
                        params != undefined ? colorTheme?.fuselageStrokeWidth / (params?.innerWidth / 200) : 0
                      }
